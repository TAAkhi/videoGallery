    ...
    l.fn.addHTML5VideoControls = function(b, e, a) {
        ...
        if (!k && (m.get(0).requestFullscreen || m.get(0).webkitRequestFullScreen || m.get(0).mozRequestFullScreen || m.get(0).webkitEnterFullScreen || m.get(0).msRequestFullscreen)) {
            ...
            G.css({
                ...
                var a = l(this).css("background-position") ?
                    l(this).css("background-position").split(" ")[0] : l(this).css("background-position-x");
                l(this).css({
        ...
        if (m.get(0).volume === a / 2 + 0.1) {
            ...
            var F = l(".html5boxVolumeButton", x),
        ...
        f = function() {
            if (m.get(0).buffered && 0 < m.get(0).buffered.length && !isNaN(m.get(0).buffered.end(0)) && !isNaN(m.get(0).duration)) {
                ...
                S.css({
                    width: Math.round(a *
                        m.get(0).buffered.end(0) / m.get(0).duration)
                })
            }
        };
        try {
    ...
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.fv ? a.options.watermarkcode = "<a id='freeLink' style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink + "' >" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink +
                    "' >");
            ...
            createSocial: function(a) {
                ...
                if (this.options.showsocial) {
                    ...
                    this.options.showfacebook && (d += '<div class="html5gallery-social-btn-' + this.id + (this.options.socialrotateeffect ?
                        " html5gallery-rotate" : "") + ' html5gallery-social-facebook" style="' + j + '"><div class="mh-icon-facebook" style="' + e + 'background-color:#3b5998;"></div></div>');
                    ...
                    this.options.showpinterest && (d += '<div class="html5gallery-social-btn-' + this.id +
                        (this.options.socialrotateeffect ? " html5gallery-rotate" : "") + ' html5gallery-social-pinterest" style="' + j + '"><div class="mh-icon-pinterest" style="' + e + 'background-color:#c92228;"></div></div>');
                    ...
                    b(".html5gallery-social-btn-" + this.id).click(function() {
                        var a = window.location.href + (0 > window.location.href.indexOf("?") ? "?" : "&") + "galleryshareid=" + c.elemArray[c.curElem][0],
                            ...
                            d = d ? c.html2Text(d) : "";
                        e &&
                            c.elemArray[c.curElem][12] && (j = c.absoluteUrl(c.elemArray[c.curElem][12]));
                        b(this).hasClass("html5gallery-social-facebook") ? window.open("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(a) + "&t=" + encodeURIComponent(d), "_blank") : b(this).hasClass("html5gallery-social-twitter") ? window.open("https://twitter.com/share?url=" + encodeURIComponent(a) + "&text=" + encodeURIComponent(d), "_blank") : b(this).hasClass("html5gallery-social-pinterest") ? window.open("https://pinterest.com/pin/create/bookmarklet/?media=" +
                            encodeURIComponent(j) + "&url=" + encodeURIComponent(a) + "&description=" + encodeURIComponent(d) + "&is_video=" + (e ? "true" : "false"), "_blank") : b(this).hasClass("html5gallery-social-email") && window.open("mailto:?subject=" + encodeURIComponent(d) + "&body=Check out this: " + encodeURIComponent(a));
                        return !1
                    })
                }
            },
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    b(this).parent().is("a") && (d = b(this).parent().attr("href"), t = b(this).parent().data("ogg"), q = b(this).parent().data("webm"), k = b(this).parent().data("link"), l = b(this).parent().data("linktarget"), n = b(this).parent().data("poster"), isNaN(b(this).parent().data("width")) || (h = b(this).parent().data("width")), isNaN(b(this).parent().data("height")) || (p = b(this).parent().data("height")), u = b(this).parent().data("hd"), m = b(this).parent().data("hdogg"), v = b(this).parent().data("hdwebm"), w = b(this).parent().data("lightboxwidth"),
                        s = b(this).parent().data("lightboxheight"), x = b(this).parent().data("youtubeapikey"), y = b(this).parent().data("youtubeplaylistid"), A = b(this).parent().data("youtubeplaylistmaxresults"), D = b(this).parent().hasClass("html5gallerylightbox"));
                ...
                b.getJSON(g, function(b) {
                    if (b && b.items)
                        for (var g = 0; g < b.items.length; g++) {
                            ...
                            p = [g, "https://img.youtube.com/vi/" + p + "/0.jpg", "https://www.youtube.com/embed/" + p, null, null, null,
            ...
            embedHTML5Video: function(a, c, d, e, f, h, k, g) {
                ...
                if ((this.options.isIE11 || this.options.isIE) && this.options.usenativehtml5controlsonie ||
                    this.options.isFirefox && this.options.usenativehtml5controlsonfirefox) this.options.nativehtml5controls = !0;
                ...
                b("video", a).get(0).setAttribute("src", (f && this.isHd ? f :
                    e) + (0 < k ? "#t=" + k : ""));
                ...
                this.elemArray[this.curElem][5] && (b("video", a).css({
                    ...
                    l.elemArray[l.curElem][5] && (l.elemArray[l.curElem][6] ? window.open(l.elemArray[l.curElem][5], l.elemArray[l.curElem][6]) :
                        window.open(l.elemArray[l.curElem][5]))
                }));
